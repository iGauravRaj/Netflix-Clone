  ...
  return (
    <div className="home-banner">
        <div className="banner-contents">
            <h1 className="banner-contents-card-title" data-uia="hero-title">Unlimited movies, TV shows and more.</h1>
            <h2 className="banner-contents-card-subtitle" data-uia="banner-contents-card-subtitle">Watch anywhere. Cancel anytime.</h2>
